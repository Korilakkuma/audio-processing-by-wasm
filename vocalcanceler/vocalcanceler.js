...
var wasmBinaryFile = 'vocalcanceler.wasm';
...
var real__vocalcanceler = asm["vocalcanceler"];
asm["vocalcanceler"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__vocalcanceler.apply(null, arguments);
};
...
var _vocalcanceler = Module["_vocalcanceler"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["vocalcanceler"].apply(null, arguments)
};
