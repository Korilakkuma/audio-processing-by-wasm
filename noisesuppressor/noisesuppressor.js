...
var wasmBinaryFile = 'noisesuppressor.wasm';
...
var real__noisesuppressor = asm["noisesuppressor"];
asm["noisesuppressor"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__noisesuppressor.apply(null, arguments);
};
...
var _noisesuppressor = Module["_noisesuppressor"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["noisesuppressor"].apply(null, arguments)
};
